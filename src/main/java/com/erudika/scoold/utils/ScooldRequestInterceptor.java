...
public class ScooldRequestInterceptor extends HandlerInterceptorAdapter {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		modelAndView.addObject("showBranding", Config.getConfigBoolean("show_branding", false));
		modelAndView.addObject("logoUrl", Config.getConfigParam("logo_url", IMAGESLINK + "/logo.svg"));
		modelAndView.addObject("logoWidth", Config.getConfigInt("logo_width", 200));
		...
		// Spaces
		modelAndView.addObject("currentSpace", utils.getValidSpaceId(authUser, HttpUtils.getCookieValue(request, SPACE_COOKIE)));
		// Language
